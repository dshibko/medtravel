...
class Role extends \Application\Entity\Role implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\Role' . "\0" . 'name', '' . "\0" . 'Application\\Entity\\Role' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Role' . "\0" . 'parent', '' . "\0" . 'Application\\Entity\\Role' . "\0" . 'permissions');
        }
